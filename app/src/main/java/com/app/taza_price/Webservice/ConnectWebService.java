package com.app.taza_price.Webservice;
...
// Adding request to request queue
    ...
    public void stringPostRequest(final String url, final Context context, Map<String, String> tempParams, final boolean dialog) {
        ...
        CustomStringRequest jsonObjReq = new CustomStringRequest(Method.POST,
            ...
            public String getBodyContentType() {
                if(url.equals(Config.COMAPRE_PRICE))
